...
/*   Updated: 2021/05/12 21:28:18 by seunghoh         ###   ########.fr       */
/*                                                                            */
/* ********a****************************************************************** */
...
void    FragTrap::fiestaAttack(std::string const &target)
{
	std::cout << std::endl;
...
void    FragTrap::canonAttack(std::string const &target)
{
	std::cout << std::endl;
...
void    FragTrap::shotAttack(std::string const &target)
{
	std::cout << std::endl;
